...
if __name__ == "__main__":
    generate_vlog(
        idea="""A capybara in japen, snowbording, and then slip and break the equipment""",
        character_description="fluffy brown capybara with sunglass",
        character_characteristics="realistic",
        video_characteristics="realistic, 4k, high quality, vibe music background",
        camera_angle="front, sport camera, no talking",
        output_dir="test",
        number_of_scenes=4,
    )
