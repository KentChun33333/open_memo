...
function dsv_default(delimiter) {
  ...
  function parseRows(text, f) {
    ...
    function token() {
      ...
      return eof = true, text.slice(j2, N);
    }
    while ((t = token()) !== EOF) {
      var row = [];
...
function polygonContains_default(polygon, point) {
  ...
  var sum2 = new Adder();
  if (sinPhi === 1) phi2 = halfPi3 + epsilon3;
  else if (sinPhi === -1) phi2 = -halfPi3 - epsilon3;
  for (var i = 0, n = polygon.length; i < n; ++i) {
    ...
    for (var j2 = 0; j2 < m; ++j2, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
      var point1 = ring[j2], lambda1 = longitude(point1), phi1 = point1[1] / 2 + quarterPi, sinPhi1 = sin2(phi1), cosPhi1 = cos2(phi1), delta = lambda1 - lambda0, sign2 = delta >= 0 ? 1 : -1, absDelta = sign2 * delta, antimeridian = absDelta > pi3, k = sinPhi0 * sinPhi1;
...
var gamma_default = (function sourceRandomGamma(source) {
  ...
  function randomGamma(k, theta) {
    ...
    return function() {
      do {
        do {
          var x2 = randomNormal(), v3 = 1 + c3 * x2;
        } while (v3 <= 0);
        v3 *= v3 * v3;
        var u4 = 1 - source();
      } while (u4 >= 1 - 0.0331 * x2 * x2 * x2 * x2 && Math.log(u4) >= 0.5 * x2 * x2 + d * (1 - v3 + Math.log(v3)));
...
function zoom_default2() {
  ...
  function mousedowned(event, ...args) {
    ...
    var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v3 = select_default2(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default(event, currentTarget), x02 = event.clientX, y0 = event.clientY;
  ...
  zoom.wheelDelta = function(_2) {
    return arguments.length ? (wheelDelta = typeof _2 === "function" ? _2 : constant_default9(+_2), zoom) : wheelDelta;
  };
  zoom.filter = function(_2) {
    return arguments.length ? (filter2 = typeof _2 === "function" ? _2 : constant_default9(!!_2), zoom) : filter2;
  };
  zoom.touchable = function(_2) {
    return arguments.length ? (touchable = typeof _2 === "function" ? _2 : constant_default9(!!_2), zoom) : touchable;
  };
  zoom.extent = function(_2) {
    return arguments.length ? (extent2 = typeof _2 === "function" ? _2 : constant_default9([[+_2[0][0], +_2[0][1]], [+_2[1][0], +_2[1][1]]]), zoom) : extent2;
  };
...
function oe(e) {
  ...
  if ((n == null ? void 0 : n.length) === 1) {
    ...
    const c3 = ordinal(n);
    t.color = (l) => c3(`${l.state.path}`);
  }
  if (s) {
    const c3 = t.color || Q.color;
    t.color = (l) => (l = {
      ...l,
      state: {
        ...l.state,
  ...
  if (o) {
    const c3 = Array.isArray(o) ? o : [o, 0, 1];
    t.lineWidth = J(
      ...c3
    );
  }
...
function j(e, t) {
  var i = new _(e), n = +e.value && (i.value = e.value), s, o = [i], h, a, c3, l;
  for (t == null && (t = Ft); s = o.pop(); )
    if (n && (s.value = +s.data.value), (a = t(s.data)) && (l = a.length))
      for (s.children = new Array(l), c3 = l - 1; c3 >= 0; --c3)
        o.push(h = s.children[c3] = new _(a[c3])), h.parent = s, h.depth = s.depth + 1;
...
function tt(e) {
  ...
  function i(a) {
    const c3 = t[a];
    return typeof c3 == "function" ? c3 : () => c3;
  }
  function n(a) {
    const c3 = h(o(), a, (l) => l.children);
    return c3.update(), c3.data;
  }
  function s() {
    const a = i("nodeSize"), c3 = i("spacing");
  ...
  function o() {
    const a = s(), c3 = i("nodeSize"), l = i("spacing");
  ...
  function h(a, c3, l) {
    const d = (p, m) => {
      ...
      const x2 = l(p) || [];
      return u4.children = x2.length === 0 ? null : x2.map((y2) => d(y2, u4)), u4.children && Object.assign(u4, u4.children.reduce(
        (y2, k) => ({
  ...
  return Object.assign(n, {
    ...
    hierarchy(a, c3) {
      const l = typeof c3 > "u" ? t.children : c3;
      return h(s(), a, l);
    },
    dump(a) {
      const c3 = i("nodeSize"), l = (d) => (p) => {
        const m = d + "  ", u4 = d + "    ", { x: x2, y: y2 } = p, k = c3(p), b = p.children || [], z = b.length === 0 ? " " : `,${m}children: [${u4}${b.map(l(u4)).join(u4)}${m}],${d}`;
...
var Kt = (e, t, i) => {
  ...
  let o = n, h = n.relX, a = s, c3 = s.relX, l = true;
  for (; o && a; ) {
    o.bottom > i.lowY && (i = i.next);
    const d = h + o.prelim - (c3 + a.prelim) + o.xSize / 2 + a.xSize / 2 + o.spacing(a);
    (d > 0 || d < 0 && l) && (c3 += d, Gt(s, d), Vt(e, t, i.index, d)), l = false;
    const p = o.bottom, m = a.bottom;
    p <= m && (o = Zt(o), o && (h += o.relX)), p >= m && (a = Yt(a), a && (c3 += a.relX));
  }
  !o && a ? qt(e, t, a, c3) : o && !a && Jt(e, t, o, h);
};
var Gt = (e, t) => {
...
`);
  ...
  _initializeData(t) {
    ...
    let o = 0, h = 0;
    return walkTree(t, (a, c3, l) => {
      var p, m, u4, x2;
      h += 1, a.children = (p = a.children) == null ? void 0 : p.map((y2) => ({ ...y2 })), i += 1, a.state = {
        ...a.state,
        depth: h,
        id: i,
        rect: {
        ...
        size: [0, 0]
      }, a.state.key = [(m = l == null ? void 0 : l.state) == null ? void 0 : m.id, a.state.id].filter(Boolean).join(".") + Et(a.content), a.state.path = [(u4 = l == null ? void 0 : l.state) == null ? void 0 : u4.path, a.state.id].filter(Boolean).join("."), n(a);
      const d = ((x2 = a.payload) == null ? void 0 : x2.fold) === 2;
      d ? o += 1 : (o || s >= 0 && a.state.depth >= s) && (a.payload = { ...a.payload, fold: 1 }), c3(), d && (o -= 1), h -= 1;
    }), t;
  }
  _relayout() {
    if (!this.state.data) return;
    this.g.selectAll(v2(M2)).selectAll(
      v2("foreignObject")
    ).each(function(c3) {
      var p;
    ...
    const { lineWidth: t, paddingX: i, spacingHorizontal: n, spacingVertical: s } = this.options, o = tt({}).children((c3) => {
      var l;
      if (!((l = c3.payload) != null && l.fold)) return c3.children;
    }).nodeSize((c3) => {
      const [l, d] = c3.data.state.size;
      return [d, l + (l ? i * 2 : 0) + n];
    }).spacing((c3, l) => (c3.parent === l.parent ? s : s * 2) + t(c3.data)), h = o.hierarchy(this.state.data);
    o(h);
    ...
    a.forEach((c3) => {
      ...
      x1: min(a, (c3) => c3.data.state.rect.x) || 0,
      y1: min(a, (c3) => c3.data.state.rect.y) || 0,
      x2: max(
        a,
        (c3) => c3.data.state.rect.x + c3.data.state.rect.width
      ) || 0,
      y2: max(
        a,
        (c3) => c3.data.state.rect.y + c3.data.state.rect.height
      ) || 0
    };
  }
  setOptions(t) {
  ...
  async renderData(t) {
    ...
    walkTree(a, (r, g, f) => {
      var E;
      (E = r.payload) != null && E.fold || g(), c3[r.state.id] = r, f && (l[r.state.id] = f.state.id), d.push(r);
    });
    const p = {}, m = {}, u4 = (r) => {
      !r || p[r.state.id] || walkTree(r, (g, f) => {
        p[g.state.id] = r.state.id, f();
      });
    }, x2 = (r) => m[p[r.state.id]] || a.state.rect, y2 = (r) => (c3[p[r.state.id]] || a).state.rect;
    m[a.state.id] = a.state.rect, t && u4(t);
    let { highlight: k } = this.state;
    k && !c3[k.state.id] && (k = void 0);
    let b = this.g.selectAll(v2(ee)).selectAll(v2("rect")).data(k ? [this._getHighlightRect(k)] : []).join("rect").attr("x", (r) => r.x).attr("y", (r) => r.y).attr("width", (r) => r.width).attr("height", (r) => r.height);
    const z = this.g.selectAll(v2(M2)).each((r) => {
    ...
    ), F = w.selectAll(v2("line")).data(
      (r) => [r],
      (r) => r.state.key
    ), N = F.enter().append("line").attr("stroke", (r) => s(r)).attr("stroke-width", 0), B2 = F.merge(N), L = w.selectAll(v2("circle")).data(
      (r) => {
        var g;
        return (g = r.children) != null && g.length ? [r] : [];
      },
      (r) => r.state.key
    ), D2 = L.enter().append("circle").attr("stroke-width", 0).attr("r", 0).on("click", (r, g) => this.handleClick(r, g)).on("mousedown", T).merge(L).attr("stroke", (r) => s(r)).attr(
      "fill",
      (r) => {
        var g;
        return (g = r.payload) != null && g.fold && r.children ? s(r) : "var(--markmap-circle-open-bg)";
      }
    ), W = this._observer, P = w.selectAll(v2("foreignObject")).data(
      (r) => [r],
      (r) => r.state.key
    ...
    ), A = this.g.selectAll(v2(te)).data(st, (r) => r.target.state.key), at = A.exit(), ot = A.enter().insert("path", "g").attr("class", "markmap-link").attr("data-depth", (r) => r.target.state.depth).attr("data-path", (r) => r.target.state.path).attr("d", (r) => {
    ...
    this.transition(ct).attr("x1", (r) => r.state.rect.width).attr("stroke-width", 0), N.attr("x1", (r) => r.state.rect.width).attr("x2", (r) => r.state.rect.width), B2.attr("y1", (r) => r.state.rect.height + h(r) / 2).attr("y2", (r) => r.state.rect.height + h(r) / 2), this.transition(B2).attr("x1", -1).attr("x2", (r) => r.state.rect.width + 2).attr("stroke", (r) => s(r)).attr("stroke-width", h);
    const ht = S.selectAll(
      v2("circle")
    );
    this.transition(ht).attr("r", 0).attr("stroke-width", 0), D2.attr("cx", (r) => r.state.rect.width).attr("cy", (r) => r.state.rect.height + h(r) / 2), this.transition(D2).attr("r", 6).attr("stroke-width", "1.5"), this.transition(I).style("opacity", 0), K.attr("width", (r) => Math.max(0, r.state.rect.width - i * 2)).attr("height", (r) => r.state.rect.height), this.transition(K).style("opacity", 1), this.transition(at).attr("d", (r) => {
  ...
  async fit(t = this.options.maxInitialScale) {
    const i = this.svg.node(), { width: n, height: s } = i.getBoundingClientRect(), { fitRatio: o } = this.options, { x1: h, y1: a, x2: c3, y2: l } = this.state.rect, d = c3 - h, p = l - a, m = Math.min(
      n / d * o,
      s / p * o,
      t
    ), u4 = identity.translate(
      (n - d * m) / 2 - h * m,
      (s - p * m) / 2 - a * m
    ).scale(m);
    return this.transition(this.svg).call(this.zoom.transform, u4).end().catch(noop);
  }
  findElement(t) {
    let i;
    return this.g.selectAll(v2(M2)).each(function(s) {
      s === t && (i = {
        data: s,
        g: this
      });
  ...
  async ensureVisible(t, i) {
    ...
    if (!n) return;
    const s = this.svg.node(), o = s.getBoundingClientRect(), h = transform(s), [a, c3] = [
      n.state.rect.x,
      ...
      bottom: 0,
      ...i
    }, m = [p.left - a, o.width - p.right - c3], u4 = [p.top - l, o.height - p.bottom - d], x2 = m[0] * m[1] > 0 ? Y2(m, Math.abs) / h.k : 0, y2 = u4[0] * u4[1] > 0 ? Y2(u4, Math.abs) / h.k : 0;
    if (x2 || y2) {
      const b = h.translate(x2, y2);
  ...
  async centerNode(t, i) {
    ...
    if (!n) return;
    const s = this.svg.node(), o = s.getBoundingClientRect(), h = transform(s), a = (n.state.rect.x + n.state.rect.width / 2) * h.k + h.x, c3 = (n.state.rect.y + n.state.rect.height / 2) * h.k + h.y, l = {
      left: 0,
      right: 0,
      top: 0,
      bottom: 0,
      ...i
    }, d = (l.left + o.width - l.right) / 2, p = (l.top + o.height - l.bottom) / 2, m = (d - a) / h.k, u4 = (p - c3) / h.k;
    if (m || u4) {
      const y2 = h.translate(m, u4);
   ...
   */
  async rescale(t) {
    const i = this.svg.node(), { width: n, height: s } = i.getBoundingClientRect(), o = n / 2, h = s / 2, a = transform(i), c3 = a.translate(
      (o - a.x) * (1 - t) / a.k,
      (h - a.y) * (1 - t) / a.k
    ).scale(t);
    return this.transition(this.svg).call(this.zoom.transform, c3).end().catch(noop);
  }
  destroy() {
