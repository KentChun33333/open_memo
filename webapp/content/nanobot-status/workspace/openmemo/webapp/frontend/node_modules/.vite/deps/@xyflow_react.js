...
} from "./chunk-PCDTWOGH.js";
import {
  require_react_dom
} from "./chunk-NCDZRFPM.js";
import {
  require_jsx_runtime
} from "./chunk-DMFHLHSF.js";
import {
  require_react
} from "./chunk-QYIFQUEX.js";
import {
  drag_default,
  identity,
  pointer_default,
...
var Panel = (0, import_react2.forwardRef)(({ position = "top-left", children, className, style: style2, ...rest }, ref) => {
...
var Marker = ({ id, type, color, width = 12.5, height = 12.5, markerUnits = "strokeWidth", strokeWidth, orient = "auto-start-reverse" }) => {
  ...
  return (0, import_jsx_runtime.jsx)("marker", { className: "react-flow__arrowhead", id, markerWidth: `${width}`, markerHeight: `${height}`, viewBox: "-10 -10 20 20", markerUnits, orient, refX: "0", refY: "0", children: (0, import_jsx_runtime.jsx)(Symbol2, { color, strokeWidth }) });
};
...
function createSimpleBezierEdge(params) {
  return (0, import_react2.memo)(({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, markerEnd, markerStart, interactionWidth }) => {
...
var createStore2 = ({ nodes, edges, defaultNodes, defaultEdges, width, height, fitView, fitViewOptions, minZoom, maxZoom, nodeOrigin, nodeExtent, zIndexMode }) => createWithEqualityFn((set, get) => {
  ...
  return {
    ...
    setNodes: (nodes2) => {
      const { nodeLookup, parentLookup, nodeOrigin: nodeOrigin2, elevateNodesOnSelect, fitViewQueued, zIndexMode: zIndexMode2 } = get();
...
function Wrapper({ children, nodes, edges, defaultNodes, defaultEdges, width, height, fitView, fitViewOptions, minZoom, maxZoom, nodeOrigin, nodeExtent, zIndexMode }) {
  ...
  return (0, import_jsx_runtime.jsx)(ReactFlowProvider, { initialNodes: nodes, initialEdges: edges, defaultNodes, defaultEdges, initialWidth: width, initialHeight: height, fitView, initialFitViewOptions: fitViewOptions, initialMinZoom: minZoom, initialMaxZoom: maxZoom, nodeOrigin, nodeExtent, zIndexMode, children });
}
var wrapperStyle = {
  width: "100%",
  height: "100%",
...
function EdgeToolbar({ edgeId, x, y, children, className, style: style2, isVisible, alignX = "center", alignY = "center", ...rest }) {
  ...
  return (0, import_jsx_runtime.jsx)(EdgeLabelRenderer, { children: (0, import_jsx_runtime.jsx)("div", { style: {
    ...
    transformOrigin: "0 0",
    ...style2
  }, className: cc(["react-flow__edge-toolbar", className]), "data-id": (edge == null ? void 0 : edge.id) ?? "", ...rest, children }) });
}
export {
  Background,
  BackgroundVariant,
