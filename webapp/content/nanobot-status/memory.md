...
- Set up daily AI news summarization from Reuters (8:30 AM, Vancouver time)  
- Successfully configured `voice-transcribe` skill using local Whisper model (no API key required)
